...
| `reference/` | On-demand detail: `connection-mapping.md`, `tableau-semantics.md` (Phase 1: Tableau → SQL/Python + consolidation), `building-cells.md` (Phase 2: native charts + styling), `gotchas.md`, `hex-file-schema.json` |
